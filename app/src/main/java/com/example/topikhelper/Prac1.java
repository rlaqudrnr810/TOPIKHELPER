...
public class Prac1 extends AppCompatActivity implements View.OnClickListener, Dialog.OnCancelListener{
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.authBtn:
                ...
                dialogLayout = dialog.inflate(R.layout.activity_prac2, null); // LayoutInflater를 통해 XML에 정의된 Resource들을 View의 형태로 반환 시켜 줌
