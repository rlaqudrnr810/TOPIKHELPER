...
public class Random_Solve_Activity extends AppCompatActivity implements Runnable {
    ...
    public void showPre(View v){
        if(count == 0){
            Toast.makeText(Random_Solve_Activity.this, "첫문제입니다.", Toast.LENGTH_LONG).show();
        }
        else{
            count--;
            wasPlaying = false;
