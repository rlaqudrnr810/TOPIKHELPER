...
public class One_Solve_Listening_Activity extends AppCompatActivity implements View.OnClickListener {
    private Button b1;
    private Button b2;
    private Button b3;
    private Button b4;
    ...
    public void showNext(){
        ...
        b4.setBackgroundColor(Color.DKGRAY);
        if(count >= 10){
            Glide.with(One_Solve_Listening_Activity.this).load("https://firebasestorage.googleapis.com/v0/b/topikhelper-4bbaa.appspot.com/o/end.png?alt=media&token=ce037580-c1d6-4618-8b3e-373fd478c374")
                    .into(imageView);
